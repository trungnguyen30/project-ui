                ...
                <div className={cx('grid-row')}>
                        ...
                        <div className={cx('product-item')}>
                            <Button toDetail to={'/product'}>
                                <div className={cx('product-img')}>
                                    <img src={img.FB_5200} className={cx('img')} />
                                </div>
                            </Button>
                            <h4 className={cx('product-title')}>
                                RAM Kingston Fury Beast RGB 16GB (2x8GB) bus 5200 DDR5 (KF552C40BBAK2-16)
                            </h4>
                    ...
                    <div className={cx('grid-column-2-4')}>
                        <div className={cx('product-item')}>
                            <Button toDetail to={'/product'}>
                                <div className={cx('product-img')}>
                                    <img src={img.FB_5600} className={cx('img')} />
                                </div>
                            </Button>
                            <h4 className={cx('product-title')}>
                                RAM Kingston Fury Beast RGB 16GB (2x8GB) bus 5600 DDR5 (KF556C40BBAK2-16)
                            </h4>
                            <div className={cx('product-price')}>
                                <span className={cx('old-price')}>1.200.000đ</span>
                                <span className={cx('new-price')}>999.000đ</span>
                    ...
                    <div className={cx('grid-column-2-4')}>
                        <div className={cx('product-item')}>
                            <Button toDetail to={'/product'}>
                                <div className={cx('product-img')}>
                                    <img src={img.FB_16GB} className={cx('img')} />
                                </div>
                            </Button>
                            <h4 className={cx('product-title')}>
                                RAM DDR5 Kingston Fury Beast 16GB 5200mhz (KF552C40BB-16)
                            </h4>
                            <div className={cx('product-price')}>
                                <span className={cx('old-price')}>1.200.000đ</span>
                                <span className={cx('new-price')}>999.000đ</span>
